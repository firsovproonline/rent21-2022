...
exports.spr = (req, res) => {
  ...
  outOb.clientRajon = [
    {id: 'Центральный', name: 'Центральный'},
    {id: 'Северный', name: 'Северный'},
    {id: 'Северо-Восточный', name: 'Северо-Восточный'},
    {id: 'Восточный', name: 'Восточный'},
    {id: 'Юго-Восточный', name: 'Юго-Восточный'},
    {id: 'Южный', name: 'Южный'},
    {id: 'Юго-Западный', name: 'Юго-Западный'},
    {id: 'Западный', name: 'Западный'},
    {id: 'Северо-Западный', name: 'Северо-Западный'},
    {id: 'Зеленоградский', name: 'Зеленоградский'}
  ]
